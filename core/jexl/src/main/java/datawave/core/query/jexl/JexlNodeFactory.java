...
public class JexlNodeFactory {
    ...
    /**
     * Helper method for
     * {@link datawave.core.query.jexl.JexlNodeFactory#createNodeTreeFromFieldsToValues(ContainerType, boolean, JexlNode, IndexLookupMap, boolean, boolean, boolean)}
     *
     * @param field
    ...
    public static JexlNode createNodeFromValuesForField(String field, IndexLookupMap fieldsToValues, JexlNode original, ContainerType type,
        ...
        if (!expandValues) {
            ...
            for (ASTIdentifier identifier : JexlASTHelper.getIdentifiers(child)) {
                if (identifier.image.equals(JexlConstants.ANY_FIELD)) {
            ...
            return isNegated ? datawave.core.query.jexl.JexlNodeFactory.buildNENode(field, value)
                            : datawave.core.query.jexl.JexlNodeFactory.buildEQNode(field, value);
            ...
            for (String value : valuesForField) {
                JexlNode child = isNegated ? datawave.core.query.jexl.JexlNodeFactory.buildNENode(field, value)
                                : datawave.core.query.jexl.JexlNodeFactory.buildEQNode(field, value);
                children.add(child);
            }
